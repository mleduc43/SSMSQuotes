...
{
    public class AddInAdapter_2014 : IAddInAdapter
    {
        ...
        public AddInAdapter_2014(object addInInst)
        {
        ...
        public IToolWindowContext CreateToolWindow(string assemblyLocation, string typeName, string caption, Guid uiTypeGuid)
        {
            ...
            if (win2 != null)
            {
                ...
                //Apparently order is very important for the next 5 statements, if not in this order you will get HRESULT errors.
                try
                {
